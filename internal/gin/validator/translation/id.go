...
func RegisterIdTranslations(v *validator.Validate, trans ut.Translator) (err error) {
	translations := []translation{
		...
		{
			tag:         "alphanum_symbol",
			translation: "{0} harus berisi karakter alfanumerik atau simbol",
			override:    false,
		},
		{
			tag:         "not_empty",
			translation: "{0} tidak boleh kosong",
			override:    false,
		},
		{
			tag:         "data_type_enum",
			translation: "{0} harus salah satu dari {1}",
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				var t string
				var err error
		...
		},
		{
			tag: "data_type_date",
			customRegisFunc: func(ut ut.Translator) (err error) {
				if err = ut.Add("data-type-date-required", "{0} wajib diisi", false); err != nil {
					return
				}

				if err = ut.Add("data-type-date-format-invalid", "{0} tidak memenuhi format {1}", false); err != nil {
					return
				}
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				if err = ut.Add("data-type-date-time-required", "{0} wajib diisi", false); err != nil {
					return
				}

				if err = ut.Add("data-type-date-time-format-invalid", "{0} tidak memenuhi format {1}", false); err != nil {
					return
				}
